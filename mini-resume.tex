...
\begin{description}
\item[\bf Computer Graphics] : fast rasterization, 3D pipeline (OpenGL), 
   GPU shaders, 
   mathematical modeling, volumetric rendering, raytracing, \ldots 
...
Intel Sports, Intel Corporation. 
Development and implementation of live video processing
